---
layout: post
title:  "푸리에 분석 - 이산 푸리에 변환과 고속 푸리에 변환(Fast Fourier Transform)"
...
#### 비트를 뒤집자
$$Q_{N}$$은 순열 행렬이라고 했습니다. 순열 행렬은 벡터의 순서를 바꿔주는 행렬입니다. 예를 들어, $$[a, b, c, d]\_T$$인 벡터가 있다고 하면, 순열 행렬을 통과하면 $$[b, c, d, a]\_T$$가 될 수 있습니다($$Q_N$$이 이렇게 바꿔준다는 건 아닙니다).
